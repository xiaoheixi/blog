...
Route::get('/createTransaction', 'TransactionsController@create');
Route::post('/storeTransaction', 'TransactionsController@store');
Route::get('/t', 'TransactionsController@index');
Route::get('/transaction/{transactionID}/edit', 'TransactionsController@edit');
Route::patch('/transaction/{transactionID}', 'TransactionsController@update');
Route::delete('/transaction/{transactionID}', 'TransactionsController@destroy');
Route::get('/transaction/{productName}', 'TransactionsController@add')->name('cart.add');
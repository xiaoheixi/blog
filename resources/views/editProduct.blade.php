...
<body>
    ...
    <h1 class="pageTitle">Fill in the form to edit a product below.</h1>
    <form action="/product/{{ $productContent->name }}" method="post" enctype='multipart/form-data'>
        ...
        <input type="text" id="description" name="description" autocomplete="off"
            value="{{ $productContent -> description }}"><br>
        ...
        <input type="file" id="cover_img" name="cover_img" autocomplete="off"
            value="{{ $productContent -> cover_img }}"><br>
        ...
        <input type="text" id="productLink" name="productLink" autocomplete="off"
            value="{{ $productContent -> productLink }}"><br>

...
<body>
    ...
    <h1 class="pageTitle">Fill in the form to edit a contact detail below.</h1>
    <form action="/contact/{{ $contactDetail->contactName }}" method="post">
        ...
        <input type="text" id="contactName" name="contactName" autocomplete="off"
            value="{{ $contactDetail->contactName }}"><br>
        ...
        <input type="text" id="contactOffice" name="contactOffice" autocomplete="off"
            value="{{ $contactDetail->contactOffice }}"><br>
        ...
        <input type="text" id="contactPostal" name="contactPostal" autocomplete="off"
            value="{{ $contactDetail->contactPostal }}"><br>
        ...
        <input type="text" id="contactAddress" name="contactAddress" autocomplete="off"
            value="{{ $contactDetail->contactAddress }}"><br>
        ...
        <input type="text" id="contactEmail" name="contactEmail" autocomplete="off"
            value="{{ $contactDetail->contactEmail }}"><br>

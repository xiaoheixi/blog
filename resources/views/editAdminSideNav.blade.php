...
<body>
    <h1 class="pageTitle">Fill in the form to edit an Admin Side Navigation Bar Option below.</h1>
    <form action="/adminSideNav/{{ $adminSideNavContent->adminSideNavName }}" method="post">
        ...
        <input type="text" id="adminSideNavName" name="adminSideNavName" autocomplete="off"
            value="{{ $adminSideNavContent -> adminSideNavName }}"><br>
        ...
        <input type="text" id="adminSideNavLink" name="adminSideNavLink" autocomplete="off"
            value="{{ $adminSideNavContent -> adminSideNavLink }}"><br>

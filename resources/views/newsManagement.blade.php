...
<body>
        ...
        <div class="row">
            ...
            <table class="table table-bordered" style="width:76%">
                ...
                <tr>
                    ...
                    <td>{{$news->newsLink}}</td>
                    <td><a href="/news/{{ $news->newsName }}/edit"><button type="button" class="btn btn-info"
    ...
    <a class="createButton" href="{{url('createNews')}}" class="btn btn-primary"> <button type="button"
